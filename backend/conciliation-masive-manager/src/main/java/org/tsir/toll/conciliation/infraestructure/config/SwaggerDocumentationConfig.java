...
public class SwaggerDocumentationConfig {
	...
	public Docket customImplementation() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("org.tsir.toll.conciliation.application.presentation"))
	...
	ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Conciliation API").description(
	...
	public OpenAPI openApi() {
		return new OpenAPI().info(new Info().title("Conciliation API").description(
				"Contiene el modelo y operaciones de administración de los recursos de modulos de la plataforma VIAL")
